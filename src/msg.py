...
def message_box(e_str, m_type=message_normal):
    
    msg = QMessageBox()
    msg.setIcon(message_type_icon[message_type[m_type]])
    msg.setStandardButtons(message_type_button[message_type[m_type]])
    msg.setEscapeButton(QMessageBox.No)
    msg.setText(e_str)
    msg.setWindowTitle("Message")
    msg.setWindowIcon(QIcon(QPixmap(icon_system.table)))
    return msg.exec_()
